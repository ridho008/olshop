...
class Rajaongkir extends CI_Controller {
	...
	private $api_key = '9000c3eb2c5a219fded1eb17cce0144f';
	...
	public function provinsi()
	{
		...
		if ($err) {
		  ...
		  // echo $response;
			...
			// echo "<pre>";
			// var_dump($array_response['rajaongkir']['results']);
			// echo "</pre>";
	...
	{
		echo "<option>-- Pilih Ekpedisi --</option>";
	...
	{
		$kotaAsal = $this->Barang_m->get_where('pengaturan', ['id_pengaturan' => '1'])->row();
		$lokasi = $kotaAsal->lokasi;
		...
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_POSTFIELDS => "origin=$lokasi&destination=$id_kota&weight=$berat&courier=$ekpedisi",
		  CURLOPT_HTTPHEADER => array(
		...
		if ($err) {
		  ...
		  // echo $response;
			$array_response = json_decode($response, true);
			// echo "<pre>";
			// var_dump($array_response['rajaongkir']['results'][0]['costs']);
			// echo "</pre>";
